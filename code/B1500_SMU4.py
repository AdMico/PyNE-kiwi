...
Development of SMU4 setup for Keysight B1500A using K2401_SMU.py from PyNE-probe/
...
class B1500_SMU4(Instrument.Instrument):
    ...
    def __init__(self):
        super(B1500_SMU4, self).__init__()
        self.dev = B1500.smu4
        self.type ="B1500_SMU4"  #We can check each instrument for its type and react accordingly
