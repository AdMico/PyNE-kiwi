...
def smu_run():
    B1500.B1500_setV1(0.0)
    B1500.B1500_setV2(0.0)
    B1500.B1500_setV3(0.0)
    B1500.B1500_setV4(0.0)
    vol1 = B1500.B1500_getV1()
    cur1 = B1500.B1500_getI1()
    vol2 = B1500.B1500_getV2()
    cur2 = B1500.B1500_getI2()
    vol3 = B1500.B1500_getV3()
    cur3 = B1500.B1500_getI3()
    vol4 = B1500.B1500_getV4()
    cur4 = B1500.B1500_getI4()
    print("SMU1 I=",cur1,"SMU1 V=",vol1,"SMU2 I=",cur2,"SMU2 V=",vol2,"SMU3 I=",cur3,"SMU3 V=",vol3,"SMU4 I=",cur4,"SMU4 V=",vol4)

    B1500.B1500_setV1(0.1)
    B1500.B1500_setV2(0.1)
    B1500.B1500_setV3(0.1)
    B1500.B1500_setV4(0.1)
    vol1 = B1500.B1500_getV1()
    cur1 = B1500.B1500_getI1()
    vol2 = B1500.B1500_getV2()
    cur2 = B1500.B1500_getI2()
    ...
    B1500.B1500_setV1(0.2)
    B1500.B1500_setV2(0.2)
    B1500.B1500_setV3(0.2)
    B1500.B1500_setV4(0.2)
    vol1 = B1500.B1500_getV1()
    cur1 = B1500.B1500_getI1()
    vol2 = B1500.B1500_getV2()
    cur2 = B1500.B1500_getI2()
    ...
    B1500.B1500_setV1(0.3)
    B1500.B1500_setV2(0.3)
    B1500.B1500_setV3(0.3)
    B1500.B1500_setV4(0.3)
    vol1 = B1500.B1500_getV1()
    cur1 = B1500.B1500_getI1()
    vol2 = B1500.B1500_getV2()
    cur2 = B1500.B1500_getI2()
